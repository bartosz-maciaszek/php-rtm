...
class Auth extends AbstractService
{
    public function checkToken($authToken = null)
    {
        ...
        return $this->rtm->get(Rtm::METHOD_AUTH_CHECK_TOKEN, array('auth_token' => $authToken))->getAuth();
    }

    public function getFrob()
    {
        $response = $this->rtm->get(Rtm::METHOD_AUTH_GET_FROB);
    ...
    public function getToken($frob = null)
    {
        ...
        return $this->rtm->get(Rtm::METHOD_AUTH_GET_TOKEN, array('frob' => $frob))->getAuth();
    }
